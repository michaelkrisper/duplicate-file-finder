...
def parse_arguments():
    ...
    group.add_argument("-top", dest="top", action="store", metavar="COUNT", type=int, help="set the amount of displayed duplicates. If 0 is given, all results will be displayed. default=10", default=10)
